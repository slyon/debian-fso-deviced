/* audiorouter.c generated by valac 0.14.2, the Vala compiler
...
static void fso_device_null_router_real_saveScenario (FsoDeviceAudioRouter* base, const gchar* scenario);
...
static void fso_device_base_audio_router_real_saveScenario (FsoDeviceBaseAudioRouter* self, const gchar* scenario);
...
void fso_device_audio_router_saveScenario (FsoDeviceAudioRouter* self, const gchar* scenario) {
	g_return_if_fail (self != NULL);
	FSO_DEVICE_AUDIO_ROUTER_GET_INTERFACE (self)->saveScenario (self, scenario);
}
...
static void fso_device_null_router_fso_device_audio_router_interface_init (FsoDeviceAudioRouterIface * iface) {
	...
	iface->saveScenario = (void (*)(FsoDeviceAudioRouter*, const gchar*)) fso_device_null_router_real_saveScenario;
...
void fso_device_base_audio_router_saveScenario (FsoDeviceBaseAudioRouter* self, const gchar* scenario) {
	g_return_if_fail (self != NULL);
	FSO_DEVICE_BASE_AUDIO_ROUTER_GET_CLASS (self)->saveScenario (self, scenario);
}
...
FsoDeviceBaseAudioRouter* fso_device_base_audio_router_construct (GType object_type) {
	...
	self = (FsoDeviceBaseAudioRouter*) g_object_new (object_type, NULL);
	return self;
}
...
static void fso_device_base_audio_router_fso_device_audio_router_interface_init (FsoDeviceAudioRouterIface * iface) {
	...
	iface->saveScenario = (void (*)(FsoDeviceAudioRouter*, const gchar*)) fso_device_base_audio_router_saveScenario;
...
GType fso_device_base_audio_router_get_type (void) {
	...
	if (g_once_init_enter (&fso_device_base_audio_router_type_id__volatile)) {
		...
		fso_device_base_audio_router_type_id = g_type_register_static (G_TYPE_OBJECT, "FsoDeviceBaseAudioRouter", &g_define_type_info, G_TYPE_FLAG_ABSTRACT);
