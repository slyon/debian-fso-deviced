...
gint _vala_main (gchar** args, int args_length1) {
	...
	_tmp0_ = fso_framework_dbus_subsystem_new ("fsodevice");
	...
	if (_tmp8_ > ((guint) 0)) {
		...
		fso_framework_logger_info (_tmp10_, "fsodeviced => mainloop");
		...
		fso_framework_logger_info (_tmp12_, "mainloop => fsodeviced");
	}
	_tmp13_ = fso_framework_theLogger;
	fso_framework_logger_info (_tmp13_, "fsodeviced shutdown.");
	result = 0;
	return result;
}
