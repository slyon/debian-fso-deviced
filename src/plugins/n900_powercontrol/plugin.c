...
extern gchar* hci_h4p;
gchar* hci_h4p = NULL;
gchar* wl12xx = NULL;

#define MODULE_NAME "fsodevice.n900_powercontrol"
...
N900BluetoothPowerControl* n900_bluetooth_power_control_new (FsoFrameworkSubsystem* subsystem, const gchar* sysfsnode);
N900BluetoothPowerControl* n900_bluetooth_power_control_construct (GType object_type, FsoFrameworkSubsystem* subsystem, const gchar* sysfsnode);
...
N900BluetoothPowerControl* n900_bluetooth_power_control_new (FsoFrameworkSubsystem* subsystem, const gchar* sysfsnode) {
	return n900_bluetooth_power_control_construct (N900_TYPE_BLUETOOTH_POWER_CONTROL, subsystem, sysfsnode);
}
...
gchar* fso_factory_function (FsoFrameworkSubsystem* subsystem, GError** error) {
	...
	sysfs_root = _tmp2_;
	_tmp3_ = sysfs_root;
	_tmp4_ = g_build_filename (_tmp3_, "devices", "platform", "hci_h4p", NULL);
	_g_free0 (hci_h4p);
	hci_h4p = _tmp4_;
	_tmp5_ = sysfs_root;
	_tmp6_ = g_build_filename (_tmp5_, "devices", "platform", "wl12xx", NULL);
	_g_free0 (wl12xx);
	wl12xx = _tmp6_;
	_tmp7_ = subsystem;
	_tmp8_ = hci_h4p;
	_tmp9_ = n900_bluetooth_power_control_new (_tmp7_, _tmp8_);
	bto = _tmp9_;
...
void fso_register_function (GTypeModule* module) {
	...
	fso_framework_logger_debug (_tmp0_, "fsodevice.n900_powercontrol fso_register_function()");
}
