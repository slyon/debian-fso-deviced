/* proximity.c generated by valac 0.16.0, the Vala compiler
...
struct _ProximityProximityResourcePrivate {
	ProximityN900* instance;
};
...
#define PROXIMITY_PROXIMITY_RESOURCE_GET_PRIVATE(o) (G_TYPE_INSTANCE_GET_PRIVATE ((o), PROXIMITY_TYPE_PROXIMITY_RESOURCE, ProximityProximityResourcePrivate))
enum  {
...
ProximityProximityResource* proximity_proximity_resource_construct (GType object_type, FsoFrameworkSubsystem* subsystem, ProximityN900* instance) {
	...
	FsoFrameworkSubsystem* _tmp0_;
	ProximityN900* _tmp1_;
	ProximityN900* _tmp2_;
	g_return_val_if_fail (subsystem != NULL, NULL);
	...
	self->priv->instance = _tmp2_;
	return self;
}


ProximityProximityResource* proximity_proximity_resource_new (FsoFrameworkSubsystem* subsystem, ProximityN900* instance) {
	return proximity_proximity_resource_construct (PROXIMITY_TYPE_PROXIMITY_RESOURCE, subsystem, instance);
}
...
static gboolean proximity_proximity_resource_real_enableResource_co (proximity_proximity_resource_enableResourceData* _data_) {
	...
	_data_->_tmp3_ = _data_->self->priv->instance;
...
static void proximity_proximity_resource_class_init (ProximityProximityResourceClass * klass) {
	...
	g_type_class_add_private (klass, sizeof (ProximityProximityResourcePrivate));
...
static void proximity_proximity_resource_instance_init (ProximityProximityResource * self) {
	self->priv = PROXIMITY_PROXIMITY_RESOURCE_GET_PRIVATE (self);
}
