...
static void router_lib_alsa_real_saveScenario (FsoDeviceBaseAudioRouter* base, const gchar* scenario);
...
static void router_lib_alsa_addScenario (RouterLibAlsa* self, const gchar* scenario, GFile* file, guint idxMainVolume) {
	...
	_controls_size_ = controls_length1;
	{
		...
		gchar* line = NULL;
		FsoDeviceMixerControl** _tmp29_;
		gint _tmp29__length1;
		guint _tmp30_;
		FsoDeviceBunchOfMixerControls* _tmp31_;
		FsoDeviceBunchOfMixerControls* bunch;
		GeeHashMap* _tmp32_;
		const gchar* _tmp33_;
		FsoDeviceBunchOfMixerControls* _tmp34_;
		_tmp1_ = file;
		...
		while (TRUE) {
			...
			{
				FsoDeviceSoundDevice* _tmp18_;
				const gchar* _tmp19_;
				FsoDeviceMixerControl* _tmp20_ = NULL;
				FsoDeviceMixerControl* control;
				FsoDeviceMixerControl** _tmp21_;
				gint _tmp21__length1;
				FsoDeviceMixerControl* _tmp22_;
				FsoDeviceMixerControl* _tmp23_;
				_tmp18_ = self->priv->device;
				_tmp19_ = line;
				_tmp20_ = fso_device_sound_device_controlForString (_tmp18_, _tmp19_, &_inner_error_);
				control = _tmp20_;
				if (_inner_error_ != NULL) {
				...
				_tmp22_ = control;
				_tmp23_ = _fso_device_mixer_control_ref0 (_tmp22_);
			...
			__catch1_fso_device_sound_error:
			{
				...
				_tmp27_ = g_strconcat ("Invalid line '", _tmp26_, "'. Ignoring.", NULL);
				_tmp28_ = _tmp27_;
		...
		_tmp29_ = controls;
		_tmp29__length1 = controls_length1;
		_tmp30_ = idxMainVolume;
		_tmp31_ = fso_device_bunch_of_mixer_controls_new (_tmp29_, _tmp29__length1, _tmp30_);
		bunch = _tmp31_;
		_tmp32_ = self->priv->allscenarios;
		_tmp33_ = scenario;
		_tmp34_ = bunch;
...
static void router_lib_alsa_initScenarios (RouterLibAlsa* self) {
	...
	if (_tmp9_) {
				...
				section = _tmp33_;
				{
					...
					if (g_strcmp0 (_tmp41_, "") != 0) {
						...
						if (!_tmp57_) {
							...
							gchar* _tmp63_ = NULL;
							gchar* _tmp64_;
							_tmp58_ = fso_framework_theLogger;
							_tmp59_ = file;
		...
		if (_tmp70_) {
			...
			_tmp72_ = fso_framework_theLogger;
		...
		__catch3_fso_device_sound_error:
		{
			...
			e = _inner_error_;
			_inner_error_ = NULL;
			_tmp91_ = fso_framework_theLogger;
			_tmp92_ = e;
...
static void router_lib_alsa_onModifiedScenario (RouterLibAlsa* self, int flags, guint32 cookie, const gchar* name) {
	...
	if (g_strcmp0 (_tmp16_, _tmp17_) == 0) {
		...
		_tmp18_ = fso_framework_theLogger;
		_tmp19_ = name;
...
"e and reloading", NULL);
		...
		if (!_tmp30_) {
			...
			__catch5_fso_device_sound_error:
			{
				...
				e = _inner_error_;
				_inner_error_ = NULL;
				_tmp47_ = fso_framework_theLogger;
				_tmp48_ = name;
		...
		_g_free0 (_tmp59_);
		{
			...
			if (!_tmp74_) {
				...
				gchar* _tmp80_ = NULL;
				gchar* _tmp81_;
				_tmp75_ = fso_framework_theLogger;
				_tmp76_ = file;
		...
		__catch6_fso_device_sound_error:
		{
			...
			e = _inner_error_;
			_inner_error_ = NULL;
			_tmp88_ = fso_framework_theLogger;
			_tmp89_ = name;
...
static void router_lib_alsa_real_saveScenario (FsoDeviceBaseAudioRouter* base, const gchar* scenario) {
	...
	g_return_if_fail (scenario != NULL);
	{
		FsoDeviceSoundDevice* _tmp0_;
		gint _tmp1_ = 0;
		FsoDeviceMixerControl** _tmp2_ = NULL;
		FsoDeviceMixerControl** _tmp3_;
		gint _tmp3__length1;
		gint __tmp3__size_;
		FsoDeviceMixerControl** _tmp4_;
		gint _tmp4__length1;
		FsoDeviceBunchOfMixerControls* _tmp5_;
		FsoDeviceBunchOfMixerControls* _tmp6_;
		FsoDeviceBunchOfMixerControls* scene;
		const gchar* _tmp7_;
		const gchar* _tmp8_;
		gchar* _tmp9_ = NULL;
		...
		_tmp2_ = fso_device_sound_device_allMixerControls (_tmp0_, &_tmp1_, &_inner_error_);
		_tmp3_ = _tmp2_;
		...
		_tmp5_ = fso_device_bunch_of_mixer_controls_new (_tmp4_, _tmp3__length1, (guint) 0);
		_tmp6_ = _tmp5_;
		_tmp4_ = (_vala_array_free (_tmp4_, _tmp4__length1, (GDestroyNotify) fso_device_mixer_control_unref), NULL);
		scene = _tmp6_;
		_tmp7_ = self->priv->dataPath;
		_tmp8_ = scenario;
		_tmp9_ = g_build_filename (_tmp7_, _tmp8_, NULL);
		filename = _tmp9_;
		_tmp10_ = scene;
		_tmp11_ = fso_device_bunch_of_mixer_controls_to_string (_tmp10_);
		_tmp12_ = _tmp11_;
		_tmp13_ = filename;
		fso_framework_file_handling_write (_tmp12_, _tmp13_, FALSE);
		_g_free0 (_tmp12_);
		_g_free0 (filename);
		_fso_device_bunch_of_mixer_controls_unref0 (scene);
	}
	...
	__catch7_g_error:
	{
		...
		_tmp20_ = g_strconcat ("Saving scenario ", _tmp16_, " failed: ", _tmp19_, NULL);
		_tmp21_ = _tmp20_;
